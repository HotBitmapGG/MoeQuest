...
public class TaoFemaleDetailsFragment extends RxBaseFragment implements RequestListener<String,GlideDrawable>
{
    ...
    public static TaoFemaleDetailsFragment newInstance(String url)
    {

        TaoFemaleDetailsFragment mDoubanMeiziDetailsFragment = new TaoFemaleDetailsFragment();
